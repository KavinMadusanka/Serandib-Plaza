...
import register from '../../assets/registerr.webp'; // Import your image here
      ...
      <Container maxWidth="xl" sx={{ marginTop: 2 }}>
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={6}>
            <Paper elevation={3} sx={{ padding: 3, display: 'flex', justifyContent: 'center' }}>
              <img src={register} alt="Registration" style={{ width: '100%', borderRadius: '8px',height:"880px" }} />
            </Paper>
          </Grid>

          {/* Right Side: Registration Form */}
          <Grid item xs={12} md={6}>
            <Box sx={{ padding: 3, borderRadius: '8px', boxShadow: 3, backgroundColor: 'white' }}>
              <Typography variant="h4" component="h1" sx={{ textAlign: 'center', fontWeight: 'bold', marginBottom: 2 }}>
